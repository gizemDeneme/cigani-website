...
const Contact: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>İletişim - Cigani Restaurant | Sığacık'ta Rezervasyon ve Ulaşım</title>
        <meta name="description" content="Cigani Restaurant iletişim bilgileri: Sığacık'ta adres, telefon, rezervasyon ve ulaşım bilgileri. Modern meyhane deneyimi için rezervasyon yapın." />
        <meta name="keywords" content="Cigani Restaurant iletişim, Sığacık rezervasyon, Cigani telefon, Sığacık restoran adresi, Cigani ulaşım, Sığacık meyhane rezervasyon" />
        <link rel="canonical" href="https://www.cigani.com.tr/iletisim" />
      </Helmet>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <a
                  href="https://instagram.com/cigani.sigacik"
                  target="_blank"
